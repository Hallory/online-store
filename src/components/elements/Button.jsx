    ...
    const getVariantStyles = () => {
        switch (variant) {
            ...
            case 'primary-outline':
                return 'grow px-6 py-[0.69rem] border border-primary-500 text-primary-500 shadow-sm hover:text-primary-600 hover:border-primary-600 active:text-primary-800 active:border-primary-800';
            case 'primary-footer':
