...
public class CustomerService {
    ...
    public Customer saveOneInit(CustomerCreateReq req, String accountId) {
    ...
    private Customer initCustomer(CustomerCreateReq req, String accountId) {
        var customer = CustomerCreateReq.dtoToModel(req);
